...
function SubPTE(props) {
  return (
    <div className="max-w-[1428px] mx-auto pt-9 md:pt-24 px-4">
      <p className='uppercase font-sansBlack text-gradient-blue text-[24px] md:text-[84px] text-center'>Play to earn</p>
      ...
      <div className="grid grid-cols-6 mt-9 md:mt-16 md:grid-cols-3 gap-x-2 gap-y-7 md:gap-y-28 md:gap-x-14">
        ...
        <div className="block col-span-6 md:hidden">
          <img
            src="/images/coin.png"
            alt="coin"
